...
// Inline SVG for AWS — SimpleIcons CDN removed this icon; path from simple-icons@9
...
type TechItem =
  | { name: string; src: string; inline?: false }
  | { name: string; src?: never; inline: true };
        ...
        <section className="relative min-h-screen overflow-hidden">
          ...
          <div className="relative z-20 min-h-screen flex items-center">
            <div className="mx-auto w-full max-w-7xl px-6 lg:px-12 pt-28 pb-20">
              ...
              >
                Aditya{' '}<span className="text-red-500">Niture</span>
              </motion.h1>
                ...
                <InfiniteSlider duration={40} durationOnHover={80} gap={80}>
                  {techStack.map((tech) => (
                    <div key={tech.name} className="flex items-center">
                      {tech.inline ? (
                        <AwsIcon className="h-6 w-auto opacity-50 hover:opacity-90 transition-opacity duration-200" />
                      ) : (
                        <img
