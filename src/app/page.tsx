...
// import Navbar from './components/Navbar'; // Optional, currently disabled
  ...
  return (
    <div className="bg-black text-white">
      ...
      <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-red-900 flex items-center justify-center relative overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="absolute inset-0 bg-gradient-to-br from-black via-gray-900 to-red-800 opacity-30 z-0 mix-blend-overlay blur-sm" />
